...
class SiteController extends AppController
{
    ...
    public function actionIndex()
    {
        ...
        /*
         * Метод render отрабатывает слеующим образом: Вначале он обращается к папке views приложения, затем
         * ищет папку соответствующую названию контроллера (SiteController => папка site), затем ищет именованный
         * вид который передали параметром (index). Именованый вид это название файла без расширения. Название Вида
         * должно соответствовать экшену в котором его рендарят (actionIndex => index)
         */
    }
